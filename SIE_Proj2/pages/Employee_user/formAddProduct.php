...
<?php
	...
	if (!empty($_SESSION['sErrorMsg'])) {
		...
		if (!empty($_SESSION['sRef'])) 	        $ref            = $_SESSION['sRef'];
        ...
        if (!empty($_SESSION['sQuantity'])) 	$quantity       = $_SESSION['sQuantity'];
        if (!empty($_SESSION['sDiscount'])) 	$discount       = $_SESSION['sDiscount'];
